...
- **`cmd/web`** — serves the Afrinic-inspired UI, JSON API, and Pacific EEZ overview (`static/img/EEZ_Oceania.svg`, Wikimedia Commons).
...
Documentation: `docs/development.md`, `docs/security.md`, `config/README.md`.
